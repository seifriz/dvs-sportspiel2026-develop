...
<section id="impressum" class="section-padding">
    <div class="container text-center">
        ...
        <p>Die Inhalte dieser Webpräsenz werden mit sorgfältiger inhaltlicher Kontrolle erstellt. Der Anbieter übernimmt aber keine Gewähr für die Aktualität, Vollständigkeit und Richtigkeit der bereitgestellten Inhalte. Die Nutzung der Inhalte der Webpräsenz erfolgt auf eigene Gefahr des Nutzers.
            Namentlich gekennzeichnete Inhalte geben die Meinung des jeweiligen Autors und nicht immer die Meinung des Anbieters wieder. Durch die Nutzung der Webpräsenz des Anbieters kommt keinerlei Vertragsverhältnis zwischen dem Nutzer und dem Anbieter zustande.</p>

        <h5>Externe Link</h5>
        <p>Diese Webpräsenz enthält externe Links (Verknüpfungen) zu Webangeboten Dritter. Diese Webangebote unterliegen der Haftung der jeweiligen Betreiber. Der Anbieter hat bei der ersten Verknüpfung der externen Links die Inhalte daraufhin überprüft, ob etwaige Rechtsverstöße bestehen. Zu
            diesem Zeitpunkt waren keine Rechtsverstöße ersichtlich. Der Anbieter hat keinen Einfluss auf die aktuelle und zukünftige Gestaltung sowie auf die Inhalte der verknüpften Seiten. Das Setzen von externen Links bedeutet nicht, dass sich der Anbieter die hinter dem Verweis oder Link
            liegenden Inhalte zu Eigen macht. Eine ständige Kontrolle der externen Links ist für den Anbieter ohne konkrete Hinweise auf Rechtsverstöße nicht zumutbar. Bei Kenntnis von Rechtsverstößen werden jedoch derartige externe Links unverzüglich gelöscht.</p>


        <h5>Urheber- und Leistungsschutzrechte</h5>
        <p>Die auf dieser Website veröffentlichten Inhalte unterliegen dem deutschen Urheber- und Leistungsschutzrecht. Jede vom deutschen Urheber- und Leistungsschutzrecht nicht zugelassene Verwertung bedarf der vorherigen schriftlichen Zustimmung des Anbieters oder jeweiligen Rechteinhabers. Dies
            gilt insbesondere für Vervielfältigung, Bearbeitung, Übersetzung, Einspeicherung, Verarbeitung bzw. Wiedergabe von Inhalten in Datenbanken oder anderen elektronischen Medien und Systemen. Inhalte und Rechte Dritter sind dabei als solche gekennzeichnet. Die unerlaubte Vervielfältigung
            oder Weitergabe einzelner Inhalte oder kompletter Seiten ist nicht gestattet und strafbar. Lediglich die Herstellung von Kopien und Downloads für den persönlichen, privaten und nicht kommerziellen Gebrauch ist erlaubt.
            Die Darstellung dieser Website in fremden Frames ist nur mit schriftlicher Erlaubnis zulässig.</p>

        <h5>Datenschutz</h5>
        <p>Durch den Besuch der Website des Anbieters können Informationen über den Zugriff (Datum, Uhrzeit, betrachtete Seite) gespeichert werden. Diese Daten sind anonymisiert und gehören nicht zu den personenbezogenen Daten. Sie werden nur zu statistischen Zwecken ausgewertet. Eine Weitergabe an
...
<footer id="footer" class="bg-dark text-white text-center py-4">
    <div class="container">
        ...
        <p><a href="mailto:info@sportspiel2026.de" class="text-white">Kontakt</a> - <a href="impressum.html" class="text-white">Impressum</a></p>
    </div>
</footer>
